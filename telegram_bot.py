...
def _build_bengali_proverb_pool(target_size=1000):
    ...
    starters = [
        ...
        "à¦§à§ˆà¦°à§à¦¯ à¦§à¦°à¦²à§‡", "à¦¸à¦¤à¦¤à¦¾ à¦°à¦¾à¦–à¦²à§‡", "à¦ªà¦°à¦¿à¦¶à§à¦°à¦® à¦•à¦°à¦²à§‡", "à¦¸à¦®à§Ÿà¦•à§‡ à¦¸à¦®à§à¦®à¦¾à¦¨ à¦•à¦°à¦²à§‡", "à¦›à§‹à¦Ÿ à¦ªà¦¦à¦•à§à¦·à§‡à¦ª à¦¨à¦¿à¦²à§‡",

        "à¦²à¦•à§à¦·à§à¦¯ à¦ à¦¿à¦• à¦°à¦¾à¦–à¦²à§‡", "à¦®à¦¨à§‹à¦¯à§‹à¦— à¦§à¦°à§‡ à¦°à¦¾à¦–à¦²à§‡", "à¦¨à¦¿à§Ÿà¦®à¦¿à¦¤ à¦šà§‡à¦·à§à¦Ÿà¦¾ à¦•à¦°à¦²à§‡", "à¦¬à¦¿à¦¶à§à¦¬à¦¾à¦¸ à¦§à¦°à§‡ à¦°à¦¾à¦–à¦²à§‡", "à¦­à§à¦² à¦¥à§‡à¦•à§‡ à¦¶à¦¿à¦–à¦²à§‡",

        "à¦¸à¦•à¦¾à¦²à§‡ à¦¶à§à¦°à§ à¦•à¦°à¦²à§‡", "à¦¦à§ƒà§ à¦¥à¦¾à¦•à¦²à§‡", "à¦¶à§ƒà¦™à§à¦–à¦²à¦¾ à¦®à¦¾à¦¨à¦²à§‡", "à¦¨à¦¿à¦œà§‡à¦•à§‡ à¦—à§à¦›à¦¿à§Ÿà§‡ à¦¨à¦¿à¦²à§‡", "à¦¹à¦¾à¦² à¦¨à¦¾ à¦›à¦¾à§œà¦²à§‡",

        "à¦¸à¦®à¦¸à§à¦¯à¦¾à¦•à§‡ à¦šà§à¦¯à¦¾à¦²à§‡à¦žà§à¦œ à¦­à¦¾à¦¬à¦²à§‡", "à¦­à§Ÿà¦•à§‡ à¦¨à¦¿à§Ÿà¦¨à§à¦¤à§à¦°à¦£ à¦•à¦°à¦²à§‡", "à¦¶à§à¦°à§à¦Ÿà¦¾ à¦•à¦°à§‡ à¦«à§‡à¦²à¦²à§‡", "à¦…à¦­à§à¦¯à¦¾à¦¸ à¦ à¦¿à¦• à¦•à¦°à¦²à§‡", "à¦¸à§à¦¬à¦ªà§à¦¨à§‡ à¦•à¦¾à¦œ à¦œà§à§œà¦²à§‡",

        "à¦‰à¦¦à§à¦¯à¦® à¦¬à¦œà¦¾à§Ÿ à¦°à¦¾à¦–à¦²à§‡", "à¦šà¦¿à¦¨à§à¦¤à¦¾ à¦ªà¦°à¦¿à¦·à§à¦•à¦¾à¦° à¦°à¦¾à¦–à¦²à§‡", "à¦•à¦¥à¦¾à¦° à¦šà§‡à§Ÿà§‡ à¦•à¦¾à¦œ à¦¬à¦¾à§œà¦¾à¦²à§‡", "à¦…à¦—à§à¦°à¦¾à¦§à¦¿à¦•à¦¾à¦° à¦ à¦¿à¦• à¦•à¦°à¦²à§‡", "à¦¸à¦¾à¦¹à¦¸ à¦¨à¦¿à§Ÿà§‡ à¦à¦—à§‹à¦²à§‡"

    ]

    middles = [

        "à¦¸à¦¾à¦«à¦²à§à¦¯ à¦à¦•à¦¦à¦¿à¦¨ à¦¦à¦°à¦œà¦¾à§Ÿ à¦•à§œà¦¾ à¦¨à¦¾à§œà¦¬à§‡à¦‡", "à¦­à¦¾à¦—à§à¦¯à¦“ à¦ªà¦°à¦¿à¦¶à§à¦°à¦®à§€à¦° à¦ªà¦¾à¦¶à§‡ à¦¦à¦¾à¦à§œà¦¾à§Ÿ", "à¦ªà§à¦°à¦¤à¦¿à¦¦à¦¿à¦¨à§‡à¦° à¦…à¦—à§à¦°à¦—à¦¤à¦¿ à¦¬à§œ à¦«à¦² à¦†à¦¨à§‡",

        "à¦…à¦¸à¦®à§à¦­à¦¬à¦“ à¦§à§€à¦°à§‡ à¦§à§€à¦°à§‡ à¦¸à¦®à§à¦­à¦¬ à¦¹à§Ÿ", "à¦•à¦·à§à¦Ÿà§‡à¦° à¦ªà¦°à§‡à¦‡ à¦¸à§à¦¬à¦¸à§à¦¤à¦¿ à¦†à¦¸à§‡", "à¦­à¦¾à¦²à§‹ à¦«à¦² à¦¸à¦®à§Ÿ à¦¨à¦¿à§Ÿà§‡ à¦†à¦¸à§‡",

        "à¦…à¦¨à§à¦§à¦•à¦¾à¦°à§‡à¦° à¦ªà¦°à§‡à¦‡ à¦†à¦²à§‹ à¦†à¦¸à§‡", "à¦…à¦­à§à¦¯à¦¾à¦¸à¦‡ à¦®à¦¾à¦¨à§à¦·à¦•à§‡ à¦à¦—à¦¿à§Ÿà§‡ à¦¦à§‡à§Ÿ", "à¦šà§‡à¦·à§à¦Ÿà¦¾ à¦•à¦–à¦¨à§‹ à¦¬à§à¦¯à¦°à§à¦¥ à¦¯à¦¾à§Ÿ à¦¨à¦¾",

        "à¦¨à¦¿à¦œà§‡à¦° à¦“à¦ªà¦° à¦­à¦°à¦¸à¦¾à¦‡ à¦¸à¦¬à¦šà§‡à§Ÿà§‡ à¦¬à§œ à¦¶à¦•à§à¦¤à¦¿", "à¦§à§€à¦° à¦—à¦¤à¦¿ à¦¹à¦²à§‡à¦“ à¦ªà¦¥ à¦ à¦¿à¦• à¦¥à¦¾à¦•à§‡", "à¦ªà¦¤à¦¨à§‡à¦° à¦­à§‡à¦¤à¦°à§‡à¦‡ à¦¶à§‡à¦–à¦¾ à¦¥à¦¾à¦•à§‡",

        "à¦¨à¦¿à¦°à¦¬à¦šà§à¦›à¦¿à¦¨à§à¦¨ à¦šà§‡à¦·à§à¦Ÿà¦¾à¦‡ à¦ªà¦¾à¦°à§à¦¥à¦•à§à¦¯ à¦—à§œà§‡", "à¦¸à¦®à§Ÿà¦®à¦¤à§‹ à¦•à¦¾à¦œà¦‡ à¦¶à¦¾à¦¨à§à¦¤à¦¿ à¦¦à§‡à§Ÿ", "à¦¸à¦‚à¦—à§à¦°à¦¾à¦®à¦‡ à¦šà¦°à¦¿à¦¤à§à¦° à¦—à§œà§‡",

        "à¦®à¦¾à¦Ÿà¦¿à¦¤à§‡ à¦¥à¦¾à¦•à¦¾ à¦®à¦¾à¦¨à§à¦·à¦‡ à¦‰à¦à¦šà§à¦¤à§‡ à¦“à¦ à§‡", "à¦­à§à¦² à¦®à¦¾à¦¨à¦¾ à¦®à¦¾à¦¨à§à¦· à¦¦à§à¦°à§à¦¤ à¦¶à§‡à¦–à§‡", "à¦¸à§Ž à¦ªà¦¥à§‡ à¦¦à§‡à¦°à¦¿ à¦¹à¦²à§‡à¦“ à¦œà§Ÿ à¦†à¦¸à§‡",

        "à¦†à¦œà¦•à§‡à¦° à¦•à¦·à§à¦Ÿà¦‡ à¦†à¦—à¦¾à¦®à§€à¦° à¦¸à¦®à§à¦ªà¦¦", "à¦à¦• à¦§à¦¾à¦ª à¦à¦—à§‹à¦²à§‡à¦‡ à¦ªà¦¥ à¦›à§‹à¦Ÿ à¦¹à§Ÿ", "à¦¨à§€à¦°à¦¬ à¦ªà¦°à¦¿à¦¶à§à¦°à¦® à¦¸à¦¬à¦šà§‡à§Ÿà§‡ à¦œà§‹à¦°à§‡ à¦•à¦¥à¦¾ à¦¬à¦²à§‡",

        "à¦šà¦¾à¦ªà§‡à¦° à¦®à¦¾à¦à§‡à¦‡ à¦¦à¦•à§à¦·à¦¤à¦¾ à¦¤à§ˆà¦°à¦¿ à¦¹à§Ÿ", "à¦†à¦¤à§à¦®à¦¬à¦¿à¦¶à§à¦¬à¦¾à¦¸ à¦¥à¦¾à¦•à¦²à§‡ à¦ªà¦¥ à¦¬à§‡à¦° à¦¹à§Ÿ", "à¦¶à§à¦°à§ à¦›à§‹à¦Ÿ à¦¹à¦²à§‡à¦“ à¦¶à§‡à¦· à¦¬à§œ à¦¹à¦¤à§‡ à¦ªà¦¾à¦°à§‡",
    ...
    endings = [
        ...
        "à¦¤à¦¾à¦‡ à¦†à¦œà¦“ à¦à¦—à¦¿à§Ÿà§‡ à¦¯à¦¾à¦“", "à¦¤à¦¾à¦‡ à¦¨à¦¿à¦œà§‡à¦° à¦—à¦¤à¦¿à¦¤à§‡ à¦šà¦²à¦¤à§‡ à¦¥à¦¾à¦•à§‹", "à¦¤à¦¾à¦‡ à¦•à¦¾à¦œà¦Ÿà¦¾à¦‡ à¦§à¦°à§‡ à¦°à¦¾à¦–à§‹",

        "à¦¤à¦¾à¦‡ à¦®à¦¨ à¦–à¦¾à¦°à¦¾à¦ª à¦¨à§Ÿ, à¦†à¦¬à¦¾à¦° à¦¶à§à¦°à§ à¦•à¦°à§‹", "à¦¤à¦¾à¦‡ à¦²à¦•à§à¦·à§à¦¯ à¦¥à§‡à¦•à§‡ à¦šà§‹à¦– à¦¸à¦°à¦¿à¦“ à¦¨à¦¾", "à¦¤à¦¾à¦‡ à¦†à¦œà¦•à§‡à¦° à¦•à¦¾à¦œ à¦†à¦œà¦‡ à¦¶à§‡à¦· à¦•à¦°à§‹",

        "à¦¤à¦¾à¦‡ à¦¹à¦¾à¦² à¦¨à¦¾ à¦›à§‡à§œà§‡ à¦¸à¦¾à¦®à¦¨à§‡ à¦¤à¦¾à¦•à¦¾à¦“", "à¦¤à¦¾à¦‡ à¦¤à§‹à¦®à¦¾à¦° à¦¸à¦®à§Ÿ à¦…à¦¬à¦¶à§à¦¯à¦‡ à¦†à¦¸à¦¬à§‡", "à¦¤à¦¾à¦‡ à¦šà§‡à¦·à§à¦Ÿà¦¾ à¦šà¦¾à¦²à¦¿à§Ÿà§‡ à¦¯à¦¾à¦“",

        "à¦¤à¦¾à¦‡ à¦…à¦²à§à¦ª à¦…à¦²à§à¦ª à¦•à¦°à§‡ à¦œà¦¿à¦¤à¦¤à§‡ à¦¥à¦¾à¦•à§‹", "à¦¤à¦¾à¦‡ à¦¨à¦¿à¦œà§‡à¦•à§‡ à¦†à¦œà¦‡ à¦†à¦°à¦“ à¦­à¦¾à¦²à§‹ à¦•à¦°à§‹", "à¦¤à¦¾à¦‡ à¦ªà§à¦°à¦¤à¦¿à¦¦à¦¿à¦¨ à§§% à¦‰à¦¨à§à¦¨à¦¤à¦¿ à¦•à¦°à§‹",

        "à¦¤à¦¾à¦‡ à¦¸à§à¦¥à¦¿à¦° à¦¥à¦¾à¦•à§‹, à¦«à¦² à¦†à¦¸à¦¬à§‡à¦‡", "à¦¤à¦¾à¦‡ à¦¸à¦‚à¦•à¦²à§à¦ª à¦¶à¦•à§à¦¤ à¦°à¦¾à¦–à§‹", "à¦¤à¦¾à¦‡ à¦ªà¦°à¦¿à¦¶à§à¦°à¦®à¦•à§‡ à¦¸à¦™à§à¦—à§€ à¦¬à¦¾à¦¨à¦¾à¦“",

        "à¦¤à¦¾à¦‡ à¦¶à§ƒà¦™à§à¦–à¦²à¦¾à¦•à§‡à¦‡ à¦¶à¦•à§à¦¤à¦¿ à¦¬à¦¾à¦¨à¦¾à¦“", "à¦¤à¦¾à¦‡ à¦¬à¦¿à¦¶à§à¦¬à¦¾à¦¸ à¦°à§‡à¦–à§‹, à¦œà§Ÿ à¦¹à¦¬à§‡", "à¦¤à¦¾à¦‡ à¦•à¦¾à¦œà¦‡ à¦¤à§‹à¦®à¦¾à¦° à¦ªà¦°à¦¿à¦šà§Ÿ à¦¹à§‹à¦•",

        "à¦¤à¦¾à¦‡ à¦¨à¦¿à¦œà§‡à¦° à¦¯à¦¾à¦¤à§à¦°à¦¾à¦•à§‡ à¦¸à¦®à§à¦®à¦¾à¦¨ à¦¦à¦¾à¦“", "à¦¤à¦¾à¦‡ à¦à¦—à§‹à¦¨à§‹à¦° à¦—à¦²à§à¦ªà¦Ÿà¦¾ à¦¥à¦¾à¦®à¦¿à¦“ à¦¨à¦¾"
...
def get_random_bn_otp_motivation():
    ...
    if not BN_OTP_MOTIVATION_LINES:
        ...
        return "à¦ªà¦°à¦¿à¦¶à§à¦°à¦®à§‡à¦° à¦«à¦² à¦à¦•à¦¦à¦¿à¦¨ à¦…à¦¬à¦¶à§à¦¯à¦‡ à¦†à¦¸à§‡à¥¤"
...
class APIClient:
    ...
    def get_number(self, range_id):
        ...
        try:
            ...
            # API usually expects prefix + XXX

            if 'X' in normalized: range_for_api = normalized

            elif len(normalized) <= 9: range_for_api = f"{normalized}XXX"

            else: range_for_api = normalized
...
COUNTRY_FLAGS = {
    ...
    'Ivory Coast': '🇨🇮', 'Japan': 'ðŸ‡¯ðŸ‡µ', 'Jordan': 'ðŸ‡¯ðŸ‡´', 'Kenya': 'ðŸ‡°ðŸ‡ª',
...
async def send_numbers_from_range_link(update: Update, context: ContextTypes.DEFAULT_TYPE, range_value, service_hint=None):
    ...
    if len(base_range) < 4:
        ...
        await update.message.reply_text("âŒ Invalid range.")
    ...
    if not numbers_data:
        ...
        await update.message.reply_text(f"âŒ Failed to get numbers for range {base_range}.")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text in ("Get Number", "ðŸ“² Get Number", "🚀 Get Number"):
    ...
    if text in ("Set Number Count", "ðŸ§® Set Number Count", "âš™ï¸ Number Count", "🎛 Number Count", "Number Count"):
    ...
    if text in ("My Stats", "ðŸ“Š My Stats", "📈 My Stats"):
    ...
    if text in ["💬 WhatsApp", "👥 Facebook", "✈️ Telegram", "ðŸŸ¢ WhatsApp", "ðŸ”µ Facebook", "ðŸ›© Telegram", "WhatsApp", "Facebook", "Telegram"]:
    ...
    # Handle country selection (old format - for backward compatibility)
        ...
        if "Back" in text:
            ...
            await update.message.reply_text(
                ...
                "âœ¨ Ready when you are. Tap 🚀 Get Number to start.",
...
async def monitor_console_logs(context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        for _, log_key, log_item in normalized_logs:
            ...
            if service in ["******", "alymscintl"]: service = "WhatsApp"
