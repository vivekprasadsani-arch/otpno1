...
SERVICE_ICONS = {
    'whatsapp': '\U0001f4de',     # 📞 WhatsApp (ID: 5233354831984353090)
    'facebook': '\U0001f465',     # 👥 Facebook (ID: 5389064576333527180)
    'telegram': '\u2708\ufe0f',  # ✈️ Telegram (ID: 5364125616801073577)
    'instagram': '\U0001f4f8',    # 📸 Instagram (ID: 5364310996179503764)
    'tiktok': '\U0001f3b5',       # 🎵 TikTok (ID: 5391044040860906456)
    'chatgpt': '\U0001f916',      # 🤖 ChatGPT (ID: 5310170944843579391)
    'grok': '\U0001f981',         # 🦁 Grok (ID: 5364325478809226894)
    '1xbet': '\U0001f3ae',        # 🎮 1xBet (ID: 5233333563306301418)
}
